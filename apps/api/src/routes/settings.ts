...
export const SETTINGS: Record<string, Record<string, SettingDef>> = {
  general: {
    ...
    social_facebook: { label: 'Facebook', help: 'Public Facebook page. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_instagram: { label: 'Instagram', help: 'Public Instagram profile. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_linkedin: { label: 'LinkedIn', help: 'Public LinkedIn page. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_x: { label: 'X', help: 'Public X profile. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_youtube: { label: 'YouTube', help: 'Public YouTube channel. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_tiktok: { label: 'TikTok', help: 'Public TikTok profile. Shown as a link in the footer of every outgoing email.', type: 'url', group: 'Social links' },
    social_whatsapp: { label: 'WhatsApp', help: 'WhatsApp link (https://wa.me/...) or a phone number. Shown in the footer of every outgoing email.', type: 'text', group: 'Social links' },
