...
export const CONTRACT_CLAUSE_SECTION: Record<string, string> = {
  ...
  INTIMIDATION_HARASSMENT: 'RIGHTS',
  MIGRANT_WORKERS: 'RIGHTS',
  ...
  IT_MONITORING: 'CONFIDENTIALITY',
  AI_TOOL_USE: 'CONFIDENTIALITY',
  BYOD_AND_REMOTE_WORK: 'CONFIDENTIALITY',
  DATA_BREACH_REPORTING: 'CONFIDENTIALITY',
  ...
  OHS_COMMITTEE: 'CONFIDENTIALITY',
  WORKPLACE_CONDUCT: 'CONFIDENTIALITY',
  NOTICE: 'TERMINATION',
  TERMINATION: 'TERMINATION',
  REDUNDANCY: 'TERMINATION',
  SEVERANCE_ALLOWANCE: 'TERMINATION',
