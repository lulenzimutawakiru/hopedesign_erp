...
async function assertAtFactory(client, ctx, loc) {
...
async function kampalaToday(client) {
...
function atKampala(workDate, timeOfDay) {
...
async function mirrorDevicePunch(client, ctx, employeeId, workDate) {
  const emp = await client.query(
