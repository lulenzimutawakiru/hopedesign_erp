...
export type BadgeKind = 'approvals' | 'inventory' | 'quality' | 'security';
    ...
    items: [
      {
        ...
        children: [
          { id: 'sd_overview', label: 'My Service Desk', href: '/service-desk', perm: 'service_desk.command.view' , group: 'Command Center'},
          { id: 'sd_new', label: 'New Request', href: '/service-desk/new', perm: 'service_desk.tickets.create' , group: 'Service Delivery'},
          { id: 'sd_dashboard', label: 'Dashboards', href: '/service-desk/dashboard', perm: 'service_desk.command.view' , group: 'Service Delivery'},
          { id: 'sd_tickets', label: 'Tickets', href: '/service-desk/tickets', perm: 'service_desk.tickets.view' , group: 'Service Delivery'},
          { id: 'sd_workspace', label: 'Agent Workspace', href: '/service-desk/workspace', perm: 'service_desk.tickets.assign' , group: 'Service Delivery'},
          { id: 'sd_queues', label: 'Queues & Teams', href: '/service-desk/queues', perm: 'service_desk.tickets.assign' , group: 'Service Delivery'},
          { id: 'sd_knowledge', label: 'Knowledge Base', href: '/service-desk/knowledge', perm: 'service_desk.knowledge.view' , group: 'ITIL Practices'},
          { id: 'sd_problems', label: 'Problems', href: '/service-desk/problems', perm: 'service_desk.problems.view' , group: 'ITIL Practices'},
          { id: 'sd_changes', label: 'Changes', href: '/service-desk/changes', perm: 'service_desk.changes.view' , group: 'ITIL Practices'},
          { id: 'sd_access', label: 'Access Requests', href: '/service-desk/access', perm: 'service_desk.access_requests.view' , group: 'ITIL Practices'},
          { id: 'sd_scan', label: 'Asset Scan', href: '/service-desk/scan', perm: 'service_desk.asset_scans.view' , group: 'Assurance'},
          { id: 'sd_reports', label: 'Reporting', href: '/service-desk/reports', perm: 'service_desk.reports.view' , group: 'Assurance'},
          { id: 'sd_config', label: 'Configuration & SLA', href: '/service-desk/config', perm: 'service_desk.sla.manage' , group: 'Administration'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'overview', label: 'Sales hub', href: '/crm', perm: 'crm.customers.view' , group: 'Command Center'},
          { id: 'mine', label: 'My work', href: '/crm/mine', perm: 'crm.activities.view' , group: 'Pipeline'},
          { id: 'leads', label: 'Leads', href: '/crm/leads', perm: 'crm.leads.view' , group: 'Pipeline'},
          { id: 'pipeline', label: 'Pipeline', href: '/crm/pipeline', perm: 'crm.opportunities.view' , group: 'Pipeline'},
          { id: 'customers', label: 'Accounts', href: '/crm/customers', perm: 'crm.customers.view' , group: 'Accounts'},
          { id: 'contacts', label: 'Contacts', href: '/crm/contacts', perm: 'crm.contacts.view' , group: 'Accounts'},
          { id: 'activities', label: 'Activities', href: '/crm/activities', perm: 'crm.activities.view' , group: 'Accounts'},
          { id: 'complaints', label: 'Cases', href: '/crm/complaints', perm: 'crm.complaints.view' , group: 'Accounts'},
          { id: 'analytics', label: 'Dashboards', href: '/crm/analytics', perm: 'crm.customers.view' , group: 'Insights'},
        ],
      },
      {
        ...
        children: [
          { id: 'overview', label: 'Command Center', href: '/sales', perm: 'sales.orders.view' , group: 'Command Center'},
          { id: 'customers', label: 'Customers', href: '/sales/customers', perm: 'sales.quotations.view' , group: 'Order Intake'},
          { id: 'quotations', label: 'Quotations', href: '/sales/quotations', perm: 'sales.quotations.view' , group: 'Order Intake'},
          { id: 'orders', label: 'Sales Orders', href: '/sales/orders', perm: 'sales.orders.view' , group: 'Order Intake'},
          { id: 'production', label: 'Production Orders', href: '/records/production/work_orders', perm: 'production.work_orders.view' , group: 'Fulfilment'},
          { id: 'pick', label: 'Warehouse Pick', href: '/inventory/pick', perm: 'inventory.stock.view' , group: 'Fulfilment'},
          { id: 'deliveries', label: 'Delivery Notes', href: '/sales/delivery_notes', perm: 'sales.delivery_notes.view' , group: 'Fulfilment'},
          { id: 'invoices', label: 'Invoices', href: '/sales/invoices', perm: 'sales.invoices.view' , group: 'Billing'},
          { id: 'receipts', label: 'Receipts', href: '/sales/receipts', perm: 'sales.receipts.view' , group: 'Billing'},
          { id: 'credits', label: 'Credit Notes', href: '/sales/credit_notes', perm: 'sales.credit_notes.view' , group: 'Billing'},
          { id: 'debits', label: 'Debit Notes', href: '/sales/debit_notes', perm: 'sales.debit_notes.view' , group: 'Billing'},
          { id: 'returns', label: 'Returns', href: '/sales/returns', perm: 'sales.returns.view' , group: 'Billing'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'overview', label: 'Board', href: '/buy', perm: 'procurement.orders.view' , group: 'Command Center'},
          { id: 'demand', label: 'Demand', href: '/buy/demand', perm: 'procurement.requisitions.view' , group: 'Sourcing'},
          { id: 'requisitions', label: 'Requisitions', href: '/buy/requisitions', perm: 'procurement.requisitions.view' , group: 'Sourcing'},
          { id: 'rfqs', label: 'RFQs', href: '/buy/rfqs', perm: 'procurement.rfqs.view' , group: 'Sourcing'},
          { id: 'orders', label: 'Purchase Orders', href: '/buy/orders', perm: 'procurement.orders.view' , group: 'Purchasing'},
          { id: 'grn', label: 'Goods Receipts', href: '/buy/receipts', perm: 'procurement.goods_receipts.view' , group: 'Purchasing'},
          { id: 'invoices', label: 'Supplier Invoices', href: '/buy/invoices', perm: 'procurement.supplier_invoices.view' , group: 'Financials'},
          { id: 'payments', label: 'Payments', href: '/buy/payments', perm: 'procurement.payments.view' , group: 'Financials'},
          { id: 'suppliers', label: 'Suppliers', href: '/records/procurement/suppliers', perm: 'procurement.suppliers.view' , group: 'Master Data'},
        ],
      },
      {
        ...
        badge: 'inventory',
        children: [
          { id: 'assets', label: 'Assets', href: '/inventory/assets', perm: 'assets.register.view' , group: 'Register'},
          { id: 'intel', label: 'Intelligence', href: '/inventory-intel/command', perm: 'inventory.stock.view' , group: 'Command Center'},
          { id: 'materials', label: 'Raw Materials', href: '/inventory/materials', perm: 'inventory.items.view' , group: 'Master Data'},
          { id: 'consumables', label: 'Factory Consumables', href: '/inventory/consumables', perm: 'inventory.items.view' , group: 'Master Data'},
          { id: 'office', label: 'Office Consumables', href: '/inventory/office', perm: 'inventory.items.view' , group: 'Master Data'},
          { id: 'products', label: 'Products', href: '/inventory/items', perm: 'inventory.items.view' , group: 'Master Data'},
          { id: 'stock', label: 'Stock', href: '/inventory/stock', perm: 'inventory.stock.view' , group: 'Stock Operations'},
          { id: 'ops', label: 'Operations', href: '/inventory/ops', perm: 'inventory.stock.view' , group: 'Stock Operations'},
          { id: 'receive', label: 'Receive', href: '/inventory/receive', perm: 'inventory.stock.view' , group: 'Stock Operations'},
          { id: 'pick', label: 'Pick', href: '/inventory/pick', perm: 'inventory.stock.view' , group: 'Stock Operations'},
          { id: 'issue', label: 'Issue', href: '/inventory/issue', perm: 'inventory.stock.view' , group: 'Stock Operations'},
          { id: 'demand', label: 'Demand / ATP', href: '/inventory/demand', perm: 'inventory.stock.view' , group: 'Planning'},
          { id: 'movements', label: 'Movements', href: '/inventory/movements', perm: 'inventory.movements.view' , group: 'Movements'},
          { id: 'transfers', label: 'Transfers', href: '/inventory/transfers', perm: 'inventory.transfers.view' , group: 'Movements'},
          { id: 'adjustments', label: 'Adjustments', href: '/inventory/adjustments', perm: 'inventory.adjustments.view' , group: 'Movements'},
          { id: 'count', label: 'Counting', href: '/inventory/adjustments/new', perm: 'inventory.adjustments.create' , group: 'Movements'},
          { id: 'batches', label: 'Batches', href: '/inventory/batches', perm: 'inventory.batches.view' , group: 'Traceability'},
          { id: 'warehouses', label: 'Warehouses', href: '/inventory/warehouses', perm: 'inventory.warehouses.view' , group: 'Configuration'},
          { id: 'asset-moves', label: 'Asset Movements', href: '/records/assets/movements', perm: 'assets.movements.view' , group: 'Configuration'},
        ],
      },
      { id: 'warehouses', label: 'Warehouses', href: '/warehouse', perm: 'inventory.stock.view', module: 'inventory', accent: 'wh', keywords: 'receive putaway pick handheld' },
      {
        ...
        children: [
          { id: 'trips', label: 'Trips', href: '/records/logistics/trips', perm: 'logistics.trips.view' , group: 'Dispatch'},
          { id: 'vehicles', label: 'Vehicles', href: '/records/logistics/vehicles', perm: 'logistics.vehicles.view' , group: 'Dispatch'},
          { id: 'drivers', label: 'Drivers', href: '/records/logistics/drivers', perm: 'logistics.drivers.view' , group: 'Master Data'},
          { id: 'routes', label: 'Routes', href: '/records/logistics/routes', perm: 'logistics.routes.view' , group: 'Master Data'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'command', label: 'Command Center', href: '/plant/command', perm: 'production.kpis.view' , group: 'Command Center'},
          { id: 'live_factory', label: 'Live Factory', href: '/plant/live', perm: 'production.machines.view' , group: 'Shop Floor'},
          { id: 'alert_center', label: 'Factory Alerts', href: '/plant/alerts', perm: 'production.kpis.view' , group: 'Shop Floor'},
          { id: 'production_wizard', label: 'Quick Create', href: '/plant/wizard', perm: 'production.work_orders.create' , group: 'Shop Floor'},
          { id: 'visual_schedule', label: 'Visual Schedule', href: '/plant/gantt-ux', perm: 'production.plans.view' , group: 'Shop Floor'},
          { id: 'operator_hub', label: 'Operator Hub', href: '/plant/operator-ux', perm: 'production.work_orders.start' , group: 'Shop Floor'},
          { id: 'qc_checklist', label: 'QC Checklist', href: '/plant/inspections-ux', perm: 'quality.inspections.view' , group: 'Shop Floor'},
          { id: 'material_issue_ux', label: 'Quick Issue', href: '/plant/issue-ux', perm: 'production.work_orders.issue' , group: 'Shop Floor'},
          { id: 'waste_recorder', label: 'Quick Waste', href: '/plant/waste-ux', perm: 'production.outputs.view' , group: 'Shop Floor'},
          { id: 'overview', label: 'Board', href: '/plant', perm: 'production.work_orders.view' , group: 'Planning'},
          { id: 'demand', label: 'Sales Demand', href: '/plant/demand', perm: 'production.work_orders.view' , group: 'Planning'},
          { id: 'plans', label: 'Plans', href: '/plant/plans', perm: 'production.plans.view' , group: 'Planning'},
          { id: 'mrp', label: 'MRP & Requisitions', href: '/plant/mrp', perm: 'production.plans.view' , group: 'Planning'},
          { id: 'dashboard', label: 'Manufacturing Dashboard', href: '/plant/dashboard', perm: 'production.kpis.view' , group: 'Planning'},
          { id: 'schedule', label: 'Schedule (Gantt)', href: '/plant/gantt', perm: 'production.plans.view' , group: 'Planning'},
          { id: 'standards', label: 'Standards', href: '/plant/standards', perm: 'production.work_orders.view' , group: 'Planning'},
          { id: 'packaging', label: 'Packaging', href: '/plant/packaging', perm: 'production.work_orders.view' , group: 'Output & Quality'},
          { id: 'inspections', label: 'QC Inspections', href: '/plant/inspections', perm: 'quality.inspections.view' , group: 'Output & Quality'},
          { id: 'wip', label: 'WIP', href: '/plant/wip', perm: 'production.work_orders.view' , group: 'Output'},
          { id: 'outputs', label: 'Outputs', href: '/plant/outputs', perm: 'production.work_orders.view' , group: 'Output'},
          { id: 'reservations', label: 'Reservations', href: '/plant/reservations', perm: 'inventory.stock.view' , group: 'Output'},
          { id: 'issues', label: 'Material Issues', href: '/plant/issues', perm: 'production.work_orders.view' , group: 'Output'},
          { id: 'waste', label: 'Waste', href: '/plant/waste', perm: 'production.work_orders.view' , group: 'Output'},
          { id: 'scrap', label: 'Scrap', href: '/plant/scrap', perm: 'production.work_orders.view' , group: 'Output'},
          { id: 'downtime', label: 'Downtime', href: '/plant/downtime', perm: 'production.kpis.view' , group: 'Assets & Reliability'},
          { id: 'machine_status', label: 'Machine Status', href: '/plant/machines', perm: 'production.machines.view' , group: 'Assets & Reliability'},
          { id: 'ncr', label: 'Manufacturing NCRs', href: '/plant/ncr', perm: 'quality.ncrs.view' , group: 'Quality'},
          { id: 'work_orders', label: 'Work Orders', href: '/plant/orders', perm: 'production.work_orders.view' , group: 'Scheduling'},
          { id: 'shifts', label: 'Shift Handover', href: '/plant/shifts', perm: 'production.work_orders.view' , group: 'Scheduling'},
            { id: 'machines', label: 'Machines', href: '/records/production/machines', perm: 'production.machines.view' , group: 'Scheduling'},
{ id: 'boms', label: 'BOMs', href: '/plant/boms', perm: 'production.boms.view' , group: 'Scheduling'},
          { id: 'costing', label: 'Costing', href: '/plant/costing', perm: 'production.costing.view' , group: 'Costing'},
          { id: 'operator', label: 'Operator Floor', href: '/operator', perm: 'production.work_orders.start' , group: 'Operator'},
        ],
      },
      {
        ...
        children: [
          { id: 'overview', label: 'Dashboard', href: '/assets', perm: 'assets.dashboards.view' , group: 'Register'},
          { id: 'register', label: 'Asset Register', href: '/assets/register', perm: 'assets.register.view' , group: 'Register'},
          { id: 'scan', label: 'Asset Scanner', href: '/assets/scan', perm: 'assets.scans.perform' , group: 'Register'},
          { id: 'verify', label: 'Verification', href: '/assets/verify', perm: 'assets.register.verify' , group: 'Register'},
          { id: 'tags', label: 'Tags', href: '/assets/tags', perm: 'assets.tags.view' , group: 'Register'},
          { id: 'custody', label: 'Custodians', href: '/assets/custody', perm: 'assets.custodians.view' , group: 'Custody'},
          { id: 'transfers', label: 'Transfers', href: '/assets/transfers', perm: 'assets.transfers.view' , group: 'Custody'},
          { id: 'audits', label: 'Audits', href: '/assets/audits', perm: 'assets.audits.view' , group: 'Lifecycle'},
          { id: 'maintenance', label: 'Maintenance', href: '/assets/maintenance', perm: 'assets.maintenance.view' , group: 'Lifecycle'},
          { id: 'depreciation', label: 'Depreciation', href: '/assets/depreciation', perm: 'assets.depreciation.view' , group: 'Lifecycle'},
          { id: 'impairments', label: 'Impairment', href: '/assets/impairments', perm: 'assets.impairments.view' , group: 'Lifecycle'},
          { id: 'disposals', label: 'Disposal', href: '/assets/disposals', perm: 'assets.disposals.view' , group: 'Lifecycle'},
          { id: 'anomalies', label: 'Anomalies', href: '/assets/anomalies', perm: 'assets.anomalies.view' , group: 'Exceptions'},
          { id: 'import', label: 'Import', href: '/assets/import', perm: 'assets.imports.view' , group: 'Data'},
          { id: 'export', label: 'Export', href: '/assets/export', perm: 'assets.exports.view' , group: 'Data'},
        ],
      },
      {
        ...
        children: [
          { id: 'requests', label: 'Work Requests', href: '/records/maintenance/requests', perm: 'maintenance.requests.view' , group: 'Work'},
          { id: 'schedules', label: 'Schedules', href: '/records/maintenance/schedules', perm: 'maintenance.schedules.view' , group: 'Work'},
          { id: 'work_orders', label: 'Maintenance WOs', href: '/records/maintenance/work_orders', perm: 'maintenance.work_orders.view' , group: 'Work'},
        ],
      },
      {
        ...
        badge: 'quality',
        children: [
          { id: 'inspections', label: 'Inspections', href: '/records/quality/inspections', perm: 'quality.inspections.view' , group: 'Inspection'},
          { id: 'ncrs', label: 'NCRs', href: '/records/quality/ncrs', perm: 'quality.ncrs.view' , group: 'Non-conformance'},
          { id: 'capa', label: 'CAPA', href: '/records/quality/capa', perm: 'quality.capa.view' , group: 'Non-conformance'},
          { id: 'defects', label: 'Defects', href: '/records/quality/defects', perm: 'quality.defects.view' , group: 'Non-conformance'},
        ],
      },
      {
        ...
        children: [
          { id: 'doc_dashboard', label: 'Dashboard', href: '/documents', perm: 'documents.command.view' , group: 'Command Center'},
          { id: 'doc_library', label: 'Library', href: '/documents/library', perm: 'documents.view' , group: 'Library'},
          { id: 'doc_folders', label: 'Folders', href: '/documents/folders', perm: 'documents.folders.manage' , group: 'Library'},
          { id: 'doc_approvals', label: 'Approvals', href: '/documents/approvals', perm: 'documents.approve' , group: 'Workflow'},
          { id: 'doc_audit', label: 'Activity', href: '/documents/audit', perm: 'documents.command.view' , group: 'Governance'},
          { id: 'doc_settings', label: 'Settings', href: '/documents/settings', perm: 'documents.settings.manage' , group: 'Governance'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        badge: 'security',
        children: [
          { id: 'jobs', label: 'Secure Jobs', href: '/security-jobs', perm: 'security_printing.jobs.view' , group: 'Operations'},
          { id: 'qr', label: 'QR & Traceability', href: '/qr/scan' , group: 'Operations'},
          { id: 'packing', label: 'Ream Packing', href: '/packing', perm: 'qr.packing.scan' , group: 'Operations'},
          { id: 'labels', label: 'Label Varieties', href: '/labels', perm: 'qr.templates.view' , group: 'Operations'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'board', label: 'Command Center', href: '/spend', perm: 'expenditure.dashboards.view' , group: 'Command Center'},
          { id: 'requisitions', label: 'Requisitions', href: '/spend/requisitions', perm: 'expenditure.requisitions.view' , group: 'Requests'},
          { id: 'expenses', label: 'Daily Expenditure', href: '/spend/expenses', perm: 'expenditure.expenses.view' , group: 'Requests'},
          { id: 'petty-cash', label: 'Petty Cash', href: '/spend/petty-cash', perm: 'expenditure.petty_cash.view' , group: 'Requests'},
          { id: 'claims', label: 'Expense Claims', href: '/spend/claims', perm: 'expenditure.claims.view' , group: 'Requests'},
          { id: 'close', label: 'Daily Close', href: '/spend/close', perm: 'expenditure.daily_close.view' , group: 'Close'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'overview', label: 'Board', href: '/people', perm: 'hr.employees.view' , group: 'Command Center'},
          { id: 'org', label: 'Org Chart', href: '/people/org', perm: 'hr.employees.view' , group: 'Organisation'},
          { id: 'positions', label: 'Positions', href: '/people/positions', perm: 'hr.positions.view' , group: 'Organisation'},
          { id: 'workforce', label: 'Workforce Plans', href: '/people/workforce', perm: 'hr.workforce_plans.view' , group: 'Organisation'},
          { id: 'requisitions', label: 'Requisitions', href: '/people/requisitions', perm: 'hr.requisitions.view' , group: 'Organisation'},
          { id: 'recruitment', label: 'Recruitment', href: '/people/recruitment', perm: 'hr.applications.view' , group: 'Recruitment'},
          { id: 'vacancies', label: 'Vacancies', href: '/people/vacancies', perm: 'hr.vacancies.view' , group: 'Recruitment'},
          { id: 'candidates', label: 'Candidates', href: '/people/candidates', perm: 'hr.candidates.view' , group: 'Recruitment'},
          { id: 'onboarding', label: 'Onboarding', href: '/people/onboarding', perm: 'hr.onboarding.view' , group: 'Recruitment'},
          { id: 'employees', label: 'Employees', href: '/people/employees', perm: 'hr.employees.view' , group: 'Employees'},
          { id: 'employee-ids', label: 'Employee IDs', href: '/people/employee-ids', perm: 'hr.employee_identity.view' , group: 'Employees'},
          { id: 'contracts', label: 'Contracts', href: '/people/contracts', perm: 'hr.contracts.view' , group: 'Employees'},
          { id: 'contract-templates', label: 'Contract Templates', href: '/people/contracts/templates', perm: 'hr.contracts.view' , group: 'Employees'},
          { id: 'expiring-contracts', label: 'Expiring', href: '/people/contracts/expiring', perm: 'hr.contracts.view' , group: 'Employees'},
          { id: 'leave', label: 'Leave', href: '/people/leave', perm: 'hr.leave.view' , group: 'Time & Leave'},
          { id: 'leave-calendar', label: 'Leave Calendar', href: '/people/leave/calendar', perm: 'hr.holidays.view' , group: 'Time & Leave'},
          { id: 'leave-balances', label: 'Leave Balances', href: '/people/leave/balances', perm: 'hr.leave_balances.view' , group: 'Time & Leave'},
          { id: 'attendance', label: 'Attendance', href: '/people/attendance', perm: 'hr.attendance.view' , group: 'Time & Leave'},
          { id: 'time', label: 'Time & Shifts', href: '/people/time', perm: 'hr.shifts.view' , group: 'Time & Leave'},
          { id: 'payroll', label: 'Payroll', href: '/people/payrolls', perm: 'hr.payrolls.view' , group: 'Payroll'},
          { id: 'payroll-runs', label: 'Payroll Runs', href: '/people/payrolls/runs', perm: 'hr.payrolls.view' , group: 'Payroll'},
          { id: 'payroll-calendar', label: 'Payroll Calendar', href: '/people/payroll-calendar', perm: 'hr.payroll_periods.view' , group: 'Payroll'},
          { id: 'payroll-exceptions', label: 'Exceptions', href: '/people/exceptions', perm: 'hr.payrolls.view' , group: 'Payroll'},
          { id: 'payroll-statutory', label: 'Statutory', href: '/people/statutory-compliance', perm: 'hr.statutory.view' , group: 'Payroll'},
          { id: 'payroll-settings', label: 'Payroll Settings', href: '/people/payroll-settings', perm: 'hr.payroll_settings.view' , group: 'Payroll'},
          { id: 'statutory-configs', label: 'Statutory Configs', href: '/people/statutory-configs', perm: 'hr.statutory_configs.view' , group: 'Payroll'},
          { id: 'loans', label: 'Loans', href: '/people/loans', perm: 'hr.loans.view' , group: 'Payroll'},
          { id: 'advances', label: 'Salary Advances', href: '/people/advances', perm: 'hr.advances.view' , group: 'Payroll'},
          { id: 'payments', label: 'Pay Batches', href: '/people/payments', perm: 'hr.payrolls.view' , group: 'Payroll'},
          { id: 'off-cycle', label: 'Off-cycle', href: '/people/off-cycle', perm: 'hr.payrolls.create' , group: 'Payroll'},
          { id: 'arrears', label: 'Arrears', href: '/people/arrears', perm: 'hr.payrolls.view' , group: 'Payroll'},
          { id: 'final-settlements', label: 'Final Settlements', href: '/people/final-settlements', perm: 'hr.final_settlements.view' , group: 'Payroll'},
          { id: 'offboardings', label: 'Offboarding', href: '/people/offboardings', perm: 'hr.offboardings.view' , group: 'Talent'},
          { id: 'performance', label: 'Performance', href: '/people/performance', perm: 'hr.performance_goals.view' , group: 'Talent'},
          { id: 'training', label: 'Training', href: '/people/training', perm: 'hr.training_catalog.view' , group: 'Talent'},
          { id: 'benefits', label: 'Benefits', href: '/people/benefits', perm: 'hr.benefit_plans.view' , group: 'Talent'},
          { id: 'relations', label: 'Relations', href: '/people/relations', perm: 'hr.grievances.view' , group: 'Talent'},
          { id: 'me', label: 'My HR', href: '/people/me', perm: 'hr.leave.view' , group: 'Self Service'},
          { id: 'my-payroll', label: 'My Payroll', href: '/people/my-payroll', perm: 'hr.employee_payroll.self_view' , group: 'Self Service'},
        ],
      },
      {
        ...
        children: [
          { id: 'live', label: 'Live', href: '/hikvision', perm: 'hikvision.dashboard.view' , group: 'Live'},
          { id: 'devices', label: 'Devices', href: '/hikvision/devices', perm: 'hikvision.devices.view' , group: 'Live'},
          { id: 'events', label: 'Events', href: '/hikvision/events', perm: 'hikvision.events.view' , group: 'Events'},
          { id: 'failed', label: 'Failed Events', href: '/hikvision/events/failed', perm: 'hikvision.events.view' , group: 'Events'},
          { id: 'exceptions', label: 'Exceptions', href: '/hikvision/exceptions', perm: 'hikvision.exceptions.view' , group: 'Events'},
          { id: 'attendance', label: 'Attendance', href: '/hikvision/attendance', perm: 'hr.attendance.view' , group: 'Attendance'},
          { id: 'health', label: 'Health', href: '/hikvision/health', perm: 'hikvision.health.view' , group: 'Health'},
          { id: 'sync', label: 'Sync', href: '/hikvision/sync', perm: 'hikvision.sync.view' , group: 'Health'},
          { id: 'reports', label: 'Reports', href: '/hikvision/reports', perm: 'hr.attendance.view' , group: 'Reporting'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'com_center', label: 'Command Center', href: '/communication', perm: 'communication.command.view' , group: 'Command Center'},
          { id: 'com_health', label: 'Health', href: '/communication/admin', perm: 'communication.command.view' , group: 'Command Center'},
          { id: 'com_messages', label: 'Messages', href: '/communication/messages', perm: 'communication.messages.view' , group: 'Collaboration'},
          { id: 'com_notifications', label: 'Notifications', href: '/communication/notifications', perm: 'communication.notifications.view' , group: 'Collaboration'},
          { id: 'com_email', label: 'Email', href: '/communication/email', perm: 'communication.emails.view' , group: 'Email'},
          { id: 'com_mail', label: 'Company Mail', href: '/communication/mail', perm: 'communication.emails.view' , group: 'Email'},
          { id: 'com_mail_approvals', label: 'Mail Approvals', href: '/communication/mail/approvals', perm: 'communication.mail_approvals.view' , group: 'Email'},
          { id: 'com_mailboxes', label: 'Mailboxes', href: '/communication/mail/mailboxes', perm: 'communication.mailboxes.view' , group: 'Email'},
          { id: 'com_mail_settings', label: 'Mail Settings', href: '/communication/mail/settings', perm: 'communication.mailboxes.manage' , group: 'Email'},
          { id: 'com_announcements', label: 'Announcements', href: '/communication/announcements', perm: 'communication.announcements.view' , group: 'Broadcast'},
          { id: 'com_templates', label: 'Templates', href: '/communication/templates', perm: 'communication.templates.view' , group: 'Broadcast'},
          { id: 'com_deliveries', label: 'Delivery Logs', href: '/communication/deliveries', perm: 'communication.delivery_logs.view' , group: 'Broadcast'},
          { id: 'com_settings', label: 'Settings', href: '/communication/settings', perm: 'communication.settings.manage' , group: 'Administration'},
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          { id: 'admindash', label: 'Dashboard', href: '/admin', perm: 'admin.users.view' , group: 'Command Center'},
          { id: 'admindatabase', label: 'Database', href: '/admin/database', perm: 'database.health.view' , group: 'Configuration'},
          { id: 'adminusers', label: 'Users', href: '/admin/users', perm: 'admin.users.view' , group: 'Identity & Access'},
          { id: 'adminroles', label: 'Roles', href: '/admin/roles', perm: 'admin.roles.view' , group: 'Identity & Access'},
          { id: 'adminpolicies', label: 'Policies', href: '/admin/policies', perm: 'admin.policies.view' , group: 'Identity & Access'},
          { id: 'adminsod', label: 'SoD', href: '/admin/sod', perm: 'admin.sod.view' , group: 'Identity & Access'},
          { id: 'adminsecurity', label: 'Security', href: '/admin/security', perm: 'admin.security.view' , group: 'Identity & Access'},
          { id: 'adminsessions', label: 'Sessions', href: '/admin/sessions', perm: 'admin.sessions.view' , group: 'Identity & Access'},
          { id: 'adminaudit', label: 'Audit', href: '/admin/audit', perm: 'admin.audit_logs.view' , group: 'Governance'},
          { id: 'adminsettings', label: 'Settings', href: '/admin/settings', perm: 'admin.settings.view' , group: 'Governance'},
          { id: 'adminfeatures', label: 'Features', href: '/admin/features', perm: 'admin.feature_flags.view' , group: 'Platform'},
          { id: 'adminhealth', label: 'Health', href: '/admin/health', perm: 'admin.health.view' , group: 'Platform'},
          { id: 'adminbackups', label: 'Backups', href: '/admin/backups', perm: 'admin.backups.view' , group: 'Platform'},
          { id: 'delegations', label: 'Delegations', href: '/admin/delegations', perm: 'governance.delegations.view' , group: 'Delegation'},
          { id: 'signatures', label: 'Signatures', href: '/admin/signatures', perm: 'governance.signature_profiles.view' , group: 'Delegation'},
          { id: 'adminorgsettings', label: 'Organisation Settings', href: '/admin/organisation-settings', perm: 'organisation.settings.view' , group: 'Organisation'},
        ],
      },
      {
    ...
    items: [
      {
        ...
        children: [
          { id: 'complianceoverview', label: 'Overview', href: '/compliance/overview', perm: 'compliance.pdpo.view' , group: 'Overview'},
          { id: 'complianceprocessing', label: 'Processing', href: '/compliance/activities', perm: 'compliance.processing_activities.view' , group: 'Processing'},
          { id: 'complianceconsents', label: 'Consents', href: '/compliance/consents', perm: 'compliance.consents.view' , group: 'Processing'},
          { id: 'compliancerequests', label: 'Subject requests', href: '/compliance/requests', perm: 'compliance.subject_requests.view' , group: 'Requests & Breaches'},
          { id: 'compliancebreaches', label: 'Breaches', href: '/compliance/breaches', perm: 'compliance.breaches.view' , group: 'Requests & Breaches'},
          { id: 'compliancefilings', label: 'Filings', href: '/compliance/filings', perm: 'compliance.pdpo.view' , group: 'Filings'},
          { id: 'complianceregistration', label: 'Registration', href: '/compliance/config', perm: 'compliance.pdpo.manage' , group: 'Filings'},
        ],
      },
    ],
  },
...
export function requiredPermForPath(path: string): string | undefined {
  ...
  if (parts[0] === 'inventory' && parts[1]) {
    const map: Record<string, string> = {
      ...
      consumables: 'inventory.items.view',
      office: 'inventory.items.view',
