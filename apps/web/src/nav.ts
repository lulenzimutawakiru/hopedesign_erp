    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'consumables', label: 'Factory Consumables', href: '/inventory/consumables', perm: 'inventory.items.view' },
          { id: 'office', label: 'Office Consumables', href: '/inventory/office', perm: 'inventory.items.view' },
