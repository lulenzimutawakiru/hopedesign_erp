...
async function ensureStatutoryConfigs(client, tenantId) {
  ...
  const defs = [
    ...
    },
    {
      category: "PAYE",
      code: "UG-PAYE-2026",
      name: "Uganda PAYE (FY2026/27 rates)",
      description: "Monthly PAYE bands effective from 01 Jul 2026. Create a new version when URA changes rates.",
    ...
    },
    {
      ...
      description: "Annual LST collected in the first four months of the FY (Jul-Oct) where applicable. Disabled by default; flip apply_to_payroll to enable.",
      effective_from: "2023-07-01",
      effective_to: null,
      version: 1,
      rates: { monthly_amount: 5000 },
      limits: { monthly_amount: 5000, min_gross: 100000, months: [7, 8, 9, 10], apply_to_payroll: false },
    },
  ];
  ...
  const wfDefs = [
    {
      ...
      desc: "HR Manager approval, Operations Manager verification, Managing Director final approval, then released to Accounting.",
      steps: [
        { seq: 1, name: "HR Manager Approval", approver_role: "hr_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
        { seq: 2, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        { seq: 3, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        { seq: 4, name: "Released to Accounting", approver_role: "accountant", amount_min: 0, amount_max: 0, sla_hours: 48 },
      ],
    },
    {
      code: "WF-WFP",
  ...
  const wfDefs = [
    {
      ...
      desc: "Operations Manager verification, Managing Director final approval, then released to Accounting.",
      steps: [
        { seq: 1, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
        { seq: 2, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        { seq: 3, name: "Released to Accounting", approver_role: "accountant", amount_min: 0, amount_max: 0, sla_hours: 48 },
      ],
    },
    {
    ...
    },
    {
      ...
      desc: "CFO approval, Operations Manager verification, Managing Director final approval, then released to Accounting.",
      steps: [
        { seq: 1, name: "CFO Approval", approver_role: "cfo", amount_min: 0, amount_max: 0, sla_hours: 24 },
        { seq: 2, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        { seq: 3, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        { seq: 4, name: "Released to Accounting", approver_role: "accountant", amount_min: 0, amount_max: 0, sla_hours: 48 },
      ],
  ...
  try {
    ...
    const workflowDefs = [
      ...
      },
      {
        ...
        entity_type: "procurement.supplier_invoices",
        desc: "CFO review, Operations Manager verification, Managing Director final approval, then release to Accounting. Blocks the accounts-payable posting until every step signs.",
        steps: [
          { seq: 1, name: "CFO Approval", approver_role: "cfo", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
          { seq: 3, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
      ...
      },
      {
        ...
        entity_type: "hr.final_settlements",
        desc: "HR Manager certification, CFO review, Operations Manager verification, Managing Director final approval, then release to Accounting for disbursement.",
        steps: [
          { seq: 1, name: "HR Manager Approval", approver_role: "hr_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "CFO Approval", approver_role: "cfo", amount_min: 0, amount_max: 0, sla_hours: 48 },
          { seq: 3, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
          { seq: 4, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
          { seq: 5, name: "Released to Accounting", approver_role: "accountant", amount_min: 0, amount_max: 0, sla_hours: 48 },
        ],
      },
      {
        code: "WF-EMP",
        name: "Employment Contract Approval",
        entity_type: "hr.contracts",
        desc: "HR Manager approval, Operations Manager verification, Managing Director final approval. A signed commitment, not a disbursement, so no Accounting release step.",
        steps: [
          { seq: 1, name: "HR Manager Approval", approver_role: "hr_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
          { seq: 3, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
      ...
      },
      {
        ...
        entity_type: "production.plans",
        desc: "Operations Manager verification then Managing Director final approval before the plan is committed to the shop floor.",
        steps: [
          { seq: 1, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        ],
      },
      {
        ...
        entity_type: "production.work_orders",
        desc: "Operations Manager verification then Managing Director final approval before a work order may be released to production.",
        steps: [
          { seq: 1, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        ],
      ...
      {
        code: "WF-BOM",
        name: "Bill of Materials Approval",
        entity_type: "production.boms",
        desc: "Operations Manager verification then Managing Director final approval. Also governs routings, which share the production.boms entity type.",
        steps: [
          { seq: 1, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        ],
      },
      {
        ...
        entity_type: "sales.quotations",
        desc: "Operations Manager verification then Managing Director final approval before a quotation is issued to a customer.",
        steps: [
          { seq: 1, name: "Operations Manager Verification", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 24 },
          { seq: 2, name: "Managing Director Final Approval", approver_role: "operations_manager", amount_min: 0, amount_max: 0, sla_hours: 48 },
        ],
