...
async function ensureContractBuilderSeed(client, tenantId, companyId = null) {
  ...
  const empTypes = [
    ...
    { code: "PROBATIONARY", name: "Probationary Employment", is_employment: true, max_duration_days: 180, notice_basis: "STATUTORY", warning: "Probation may not exceed six months under the Employment Act, 2006 (Chapter 226)." },
  ...
  const law = "Employment Act, 2006";
  const chapter = "Chapter 226";
  const source = "ULII consolidation of Chapter 226 (current version 5 June 2026, incl. Employment (Amendment) Act, 2026)";
  const legalDefs = [
    ...
    { code: "SICK_LEAVE", name: "Sick Leave", section: null, enforcement: "HARD", effective_from: "2006-08-23",
      description: "Paid sick leave of 12 working days per year, available after one month of service and on production of a medical certificate.",
      rules: { sick_leave_days: 12, qualifying_months: 1, medical_certificate: true } },
    ...
    { code: "SEXUAL_HARASSMENT", name: "Sexual Harassment", section: null, enforcement: "HARD", effective_from: "2006-08-23",
      description: "Sexual harassment in the workplace is prohibited and employers must take reasonable steps to prevent and address it.",
      rules: { prohibited: true, employer_prevention_duty: true } },
  ...
  // version 2 snapshots reflecting amendments and the 2026 consolidation
  const v2Snapshots = [
    { code: "NOTICE_PERIOD" },
    { code: "WRITTEN_PARTICULARS" },
    {
      code: "SICK_LEAVE",
      description: "Paid sick leave of 12 working days per year, available after one month of service. A medical certificate is required for an absence of 7 or more consecutive days (as amended by the Employment (Amendment) Act, 2023; consolidated in the ULII current version 5 June 2026).",
      rulesOverride: { sick_leave_days: 12, qualifying_months: 1, medical_certificate: true, certificate_required_after_days: 7 },
    },
  ];
  for (const snap of v2Snapshots) {
    ...
    await insertOne(client, "legal_rules", {
      ...
      section: b.section,
      description: snap.description ?? `${b.description} (as consolidated under the Employment (Amendment) Act, 2026; ULII current version 5 June 2026.)`,
  ...
  const templateDefs = [
    { code: "TMPL-PERM", name: "Permanent Employment Contract", contract_type: "PERMANENT",
      ...
      content: [
        ...
        { section_code: "DUTIES", clauses: ["DUTIES"] },
        ...
        { section_code: "TERMINATION", clauses: ["NOTICE", "TERMINATION", "REDUNDANCY", "DISCIPLINARY", "GRIEVANCE", "DISPUTE_RESOLUTION"] },
  ...
  const clauseDefs = [
    ...
    { code: "OVERTIME", name: "Overtime", category: "Overtime", required: "CONDITIONAL", rule: null,
      ...
      text: "Overtime shall be compensated in accordance with the Employment Act, 2006 (Chapter 226) and the Employer's overtime policy, at a rate not less than the statutory rate." },
    ...
    { code: "ANNUAL_LEAVE", name: "Annual Leave", category: "Leave", required: "REQUIRED", rule: "ANNUAL_LEAVE",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to paid annual leave of {{annual_leave_days}} working days per year, accruing at not less than the statutory rate of 7 working days per 4 months of service, in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "SICK_LEAVE", name: "Sick Leave", category: "Leave", required: "REQUIRED", rule: "SICK_LEAVE",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to paid sick leave of up to 12 working days per year after one month of service, on production of a medical certificate, in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "MATERNITY_LEAVE", name: "Maternity Leave", category: "Leave", required: "REQUIRED", rule: "MATERNITY_LEAVE",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to paid maternity leave of 60 working days in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "PATERNITY_LEAVE", name: "Paternity Leave", category: "Leave", required: "REQUIRED", rule: "PATERNITY_LEAVE",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to paid paternity leave of 4 working days in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "PROBATION", name: "Probation", category: "Probation", required: "CONDITIONAL", rule: "PROBATION_MAX_DURATION",
      ...
      text: "The Employee serves a probationary period from {{employment.start_date}} to {{probation.end_date}}. The probationary period shall not exceed six months and may be extended only to the extent permitted by the Employment Act, 2006 (Chapter 226)." },
    ...
    { code: "NOTICE", name: "Notice Period", category: "Notice", required: "REQUIRED", rule: "NOTICE_PERIOD",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Either party may terminate this contract by giving not less than the statutory notice under the Employment Act, 2006 (Chapter 226), s.58(3), being {{contract.notice_period}} days based on the Employee's continuous service, or by payment in lieu where permitted by law." },
    { code: "TERMINATION", name: "Termination", category: "Termination", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "This contract may be terminated in accordance with the Employment Act, 2006 (Chapter 226), including by notice, payment in lieu of notice where permitted, summary dismissal for gross misconduct, or redundancy. On termination, the Employer shall issue a certificate of service as required by law." },
    { code: "REDUNDANCY", name: "Redundancy", category: "Redundancy", required: "OPTIONAL", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "In the event of redundancy, the Employer shall comply with the Employment Act, 2006 (Chapter 226) and pay any statutory redundancy entitlements due." },
    { code: "DISCIPLINARY", name: "Disciplinary Matters", category: "Disciplinary Matters", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is subject to the Employer's disciplinary rules. Disciplinary action shall be taken in accordance with the Employment Act, 2006 (Chapter 226) and the principles of natural justice, including a fair hearing." },
    ...
    { code: "DISPUTE_RESOLUTION", name: "Dispute Resolution", category: "Dispute Resolution", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Any dispute arising from this contract shall first be raised internally and, if unresolved, may be referred to the Labour Officer or the Industrial Court in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "GOVERNING_LAW", name: "Governing Law", category: "Applicable Law", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "This contract is governed by the laws of the Republic of Uganda, including the Employment Act, 2006 (Chapter 226) and its amendments." },
    ...
    { code: "HEALTH_SAFETY", name: "Health and Safety", category: "Health & Safety", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall provide a safe and healthy workplace and the Employee shall comply with all health and safety requirements and report hazards promptly." },
    ...
    { code: "CERTIFICATE_OF_SERVICE", name: "Certificate of Service", category: "Termination", required: "REQUIRED", rule: "CERTIFICATE_OF_SERVICE",
      ...
      text: "This certificate is issued under the Employment Act, 2006 (Chapter 226) confirming the Employee's period of continuous employment with the Employer, the position held, and the wages payable at termination." },
    // ---- Working time, rest and public holidays (WORKING_HOURS) ----
    { code: "WORKING_TIME", name: "Hours of Work", category: "Working Hours", required: "REQUIRED", rule: "WORKING_TIME", legalRef: "Employment Act, 2006, s.52 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee's normal working hours shall not exceed 8 hours a day or 48 hours a week, in accordance with the Employment Act, 2006 (Chapter 226), s.52. Work beyond normal hours is overtime and is compensated at the statutory premium." },
    { code: "WEEKLY_REST", name: "Weekly Rest", category: "Working Hours", required: "REQUIRED", rule: "WEEKLY_REST", legalRef: "Employment Act, 2006, s.50 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to at least 24 consecutive hours of rest in each week and shall not be required to work more than six consecutive working days, in accordance with the Employment Act, 2006 (Chapter 226), s.50." },
    { code: "REST_BREAKS", name: "Rest Breaks", category: "Working Hours", required: "REQUIRED", rule: "WORKING_TIME", legalRef: "Employment Act, 2006, s.52 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to a rest break of not less than 30 minutes during a working shift of 8 hours or more, in accordance with the Employment Act, 2006 (Chapter 226), s.52." },
    { code: "PUBLIC_HOLIDAYS", name: "Public Holidays", category: "Working Hours", required: "REQUIRED", rule: "PUBLIC_HOLIDAYS", legalRef: "Employment Act, 2006, s.53 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employee is entitled to paid leave on public holidays. Work performed on a public holiday shall be compensated at not less than twice the normal rate, in accordance with the Employment Act, 2006 (Chapter 226), s.53." },
    ...
    { code: "WAGES_PAYMENT", name: "Payment of Wages", category: "Salary", required: "REQUIRED", rule: "PAYMENT_OF_WAGES",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall pay the Employee's wages in full, in Uganda Shillings, at intervals of not more than one month, and shall provide the Employee with a written pay slip recording the amounts paid and any deductions made, in accordance with the Employment Act, 2006 (Chapter 226)." },
    ...
    { code: "DEDUCTIONS", name: "Permitted Deductions", category: "Salary", required: "REQUIRED", rule: "DEDUCTIONS",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Deductions from the Employee's wages shall be made only where required or authorised by law, by court order, or with the Employee's written agreement, and shall not reduce the Employee's wages below the statutory floor, in accordance with the Employment Act, 2006 (Chapter 226)." },
    // ---- Leave (LEAVE) ----
    { code: "COMPASSIONATE_LEAVE", name: "Compassionate Leave", category: "Leave", required: "OPTIONAL", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer may grant paid or unpaid compassionate leave in accordance with the Employer's leave policy. This clause is a contractual benefit and does not reduce any statutory entitlement of the Employee under the Employment Act, 2006 (Chapter 226)." },
    // ---- Rights and non-discrimination (RIGHTS) ----
    { code: "NON_DISCRIMINATION", name: "Non-Discrimination", category: "Rights", required: "REQUIRED", rule: "NON_DISCRIMINATION", legalRef: "Employment Act, 2006, s.5 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall not discriminate against the Employee on grounds including race, colour, sex, religion, political opinion or affiliation, ethnic origin, family responsibility, disability or HIV status, in accordance with the Employment Act, 2006 (Chapter 226), s.5." },
    { code: "EQUAL_PAY", name: "Equal Pay for Work of Equal Value", category: "Rights", required: "REQUIRED", rule: "EQUAL_PAY", legalRef: "Employment Act, 2006, s.5(7) (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall provide equal remuneration to men and women performing work of equal value, in accordance with the Employment Act, 2006 (Chapter 226), s.5(7)." },
    { code: "FORCED_LABOUR_PROHIBITION", name: "Prohibition of Forced Labour", category: "Rights", required: "REQUIRED", rule: "FORCED_LABOUR", legalRef: "Employment Act, 2006, s.4 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall not require or compel the Employee to perform forced or compulsory labour. All work under this contract is performed voluntarily, in accordance with the Employment Act, 2006 (Chapter 226), s.4." },
    { code: "PREGNANCY_PROTECTION", name: "Protection from Dismissal for Pregnancy", category: "Rights", required: "REQUIRED", rule: "PREGNANCY_PROTECTION", legalRef: "Employment Act, 2006, s.75(a) (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall not dismiss the Employee on account of pregnancy or an illness arising out of pregnancy, in accordance with the Employment Act, 2006 (Chapter 226), s.75(a)." },
    { code: "SEXUAL_HARASSMENT", name: "Sexual Harassment", category: "Rights", required: "REQUIRED", rule: "SEXUAL_HARASSMENT",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Sexual harassment in the workplace is prohibited. The Employee may raise a complaint of sexual harassment through the Employer's grievance procedure without fear of victimisation, in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "CHILD_LABOUR_PROHIBITION", name: "Prohibition of Child Labour", category: "Rights", required: "REQUIRED", rule: "CHILD_LABOUR", legalRef: "Employment Act, 2006, s.7 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer confirms that the Employee is not below the minimum working age and shall not employ any person below 15 years of age, in accordance with the Employment Act, 2006 (Chapter 226), s.7." },
    { code: "YOUNG_PERSONS_EMPLOYMENT", name: "Employment of Young Persons", category: "Rights", required: "OPTIONAL", rule: "CHILD_LABOUR", legalRef: "Employment Act, 2006, s.8 (Chapter 226)",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "If the Employee is a young person aged 15 to 17 years, employment is subject to the written authorisation of the Commissioner and shall not involve hazardous work or night work, in accordance with the Employment Act, 2006 (Chapter 226), s.8." },
    // ---- Records (GENERAL) ----
    { code: "EMPLOYMENT_RECORDS", name: "Employment Records", category: "General", required: "REQUIRED", rule: "EMPLOYMENT_RECORDS",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer shall keep accurate records of the Employee's particulars, working hours, wages and leave, and shall produce them for inspection by a labour officer on request, in accordance with the Employment Act, 2006 (Chapter 226)." },
    // ---- Termination (TERMINATION) ----
    { code: "SUMMARY_DISMISSAL", name: "Summary Dismissal", category: "Termination", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "The Employer may dismiss the Employee without notice only for gross misconduct justifying summary dismissal under the Employment Act, 2006 (Chapter 226), and after giving the Employee an opportunity to be heard." },
    { code: "UNFAIR_TERMINATION", name: "Unfair Termination", category: "Termination", required: "REQUIRED", rule: "UNFAIR_TERMINATION",
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Termination of this contract shall be only for a valid reason connected with the Employee's capacity, conduct or the Employer's operational requirements, and after a fair hearing, in accordance with the Employment Act, 2006 (Chapter 226)." },
    { code: "TERMINAL_BENEFITS", name: "Terminal Benefits", category: "Termination", required: "REQUIRED", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "On termination of employment, the Employer shall pay all wages due, pay in lieu of accrued leave, and any other terminal benefits due to the Employee under this contract or by law, and shall issue a certificate of service as required by the Employment Act, 2006 (Chapter 226)." },
    { code: "REDUNDANCY_NOTICE", name: "Redundancy Notice", category: "Termination", required: "OPTIONAL", rule: null,
      contracts: ALL_EMP, conditions: [], conflicts: [],
      text: "Where the Employee's position becomes redundant, the Employer shall give notice and consult with the Employee and, where applicable, the labour office, and shall pay any statutory redundancy entitlements due under the Employment Act, 2006 (Chapter 226)." },
  ...
  for (const c of clauseDefs) {
    ...
    await insertOne(client, "contract_clauses", {
      ...
      legal_reference: c.legalRef ?? (c.rule ? `Employment Act, 2006 (Chapter 226)` : null),
